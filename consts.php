...
<head>
  ...
  <script type="text/javascript">
      function HideElements() {
        var el1 = document.getElementById("corousel123");
        var el2 = document.getElementById("hideThis168");
  ...
  <div class="sidebar">
    ...
    <div class="main-container">
      ...
      <!--  <button onclick="myfun()" id="box">
       ...
       <!--  -------------------------->
       <div class="corousel" class="item" id="corousel123">
    ...
    <!-- ------------------------------ -->
    <div class="spotify-playlists" id="spotify-playlists" id="hideThis168">
      <h2>U-music Category</h2>
      <div class="list" >

        <div class="item" onlick="HideElements()">
         <a href="#">
...
<div class="spotify-playlists">
  ...
  <div class="list">
   ...
   <div class="item">
    ...
    <div class="play">
      <span onclick="playthis(8);" ondblclick="pauseSong()" class="fa fa-play"></span>
      <a href="">
        <div class="play" <?php echo $showDownload;?> style="margin: 0 60px 0 0;">
         <span class="fa fa-download">
         </a>
